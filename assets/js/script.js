...
$(".list-group").on("click", "span", function() {
  ...
  //enable jquery ui datepicker on when date is being edited 
...
var auditTask = function(taskEl) {
  ...
  //convert to moment object at local 5:00pm 
  ...
  //this should print out an object for the value fo the date variable, but at 5:00pm of that date
  // console.log(time);
  console.log(taskEl);
};
